...
class CargaTolvas {
    static private $tableName = 'cantidad_tolvas';
    ...
    static public function getAll(){
        ...
        $sql = "SELECT c.*,
            va.tipo AS tolva, pt.nombre AS planta, em.nombre AS empresa, mi.tipo AS mineral
    ...
    static public function insert($data){
        ...
        if($stmt->execute()){
            ...
            $sqlVagon = "INSERT INTO $vagonTable (id_cantidad_tol) VALUES ($idenficador)";
