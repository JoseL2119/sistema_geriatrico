...
class CargaBarco {
    static private $tableName = 'carga_barco_pzo';

    static public function getAll(){
        $table = self::$tableName;
        // $sql = "SELECT * FROM $table ORDER BY fecha";
        $sql = "SELECT c.*,
            em.nombre AS empresa, mi.nombre AS mineral
            FROM carga_barco_pzo c
            INNER JOIN empresa_extranjera em ON c.id_empresa = em.id
            INNER JOIN tipos_de_minerales_pzo mi ON c.id_mineral = mi.id
    ...
    static public function getById($id){
        ...
        $sql = "SELECT c.*, 
            ...
            mi.id AS id_mineral, mi.nombre AS mineral
            FROM carga_barco_pzo c
            INNER JOIN empresa_extranjera em ON c.id_empresa = em.id
            INNER JOIN tipos_de_minerales_pzo mi ON c.id_mineral = mi.id
            WHERE c.id = :id";
