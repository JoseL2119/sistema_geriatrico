...
class CargosPendientes {
    static private $tableName = 'cargos_pendientes_residente';

    static public function getAll(){
        $table = self::$tableName;
        //$sql = "SELECT * FROM $table";
        $sql = "SELECT c.*,
            r.nombres AS nombres, r.apellidos AS apellidos
            FROM cargos_pendientes_residente c
            INNER JOIN residentes r ON c.id_residente = r.id
            ORDER BY c.id ASC";
