...
class ReportesSalaControl {
    static private $tableName = 'reportes_sala_control';
    ...
    static public function getAll(){
        ...
        $sql = "SELECT e.*,
            ...
            FROM reportes_sala_control e
            INNER JOIN supervisores su ON e.id_supervisor_encargado = su.id
            ORDER BY e.hora ASC";
