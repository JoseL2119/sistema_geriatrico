...
class InventarioExc {
    static private $tableName = 'inventario_exc_cd_piar';
    ...
    static public function getAll(){
        ...
        $sql = "SELECT i.*,
            ma.tipo AS material, mi.nombre AS mina
            FROM inventario_exc_cd_piar i
            INNER JOIN material_excavado ma ON i.id_tipo = ma.id
            INNER JOIN minas mi ON i.id_mina = mi.id
    ...
    static public function getById($id){
        ...
        $sql = "SELECT i.*, 
            ma.id AS id_tipo, ma.tipo AS material, 
    ...
    static public function insert($data){
        ...
        if($stmt->execute()){
            ...
            $sqlInventario = "INSERT INTO $inventarioTable (id_m_excavado) VALUES ($idenficador)";
