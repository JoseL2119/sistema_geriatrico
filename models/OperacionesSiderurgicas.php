...
class OperacionesSiderurgicas {
    static private $tableName = 'operaciones_siderurgicas';
    ...
    static public function getAll(){
        ...
        $sql = "SELECT p.*,
            pt.nombre AS planta
            FROM operaciones_siderurgicas p
            INNER JOIN plantas_siderurgicas pt ON p.id_planta_s = pt.id
    ...
    static public function getById($id){
        ...
        $sql = "SELECT p.*, 
            pt.id AS id_planta_s, pt.nombre AS planta
            FROM operaciones_siderurgicas p
            INNER JOIN plantas_siderurgicas pt ON p.id_planta_s = pt.id
            WHERE p.id = :id";
