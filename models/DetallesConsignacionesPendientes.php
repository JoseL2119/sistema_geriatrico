...
class DetallesConsignacionesPendientes {
    static private $tableName = 'vista_consignaciones_pendientes';

    static public function getAll(){
        $table = self::$tableName;
        //$sql = "SELECT * FROM $table";
        $sql = "SELECT v.*
            FROM vista_consignaciones_pendientes v
            ORDER BY v.cedula_residente ASC";
    ...
    static public function update($id, $data){
        ...
        $sql = "UPDATE $table SET $columnas WHERE id_residente = :id";
