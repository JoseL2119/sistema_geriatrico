...
<html lang="es">
  ...
  <body>
    ...
    <section id="lista">
        <div class="page-header">
            ...
            <button type="button" class="btn btn-primary btn-app shadow-sm" id="nuevo">
                <i class="fas fa-plus-circle me-2"></i>Nuevo Insumo
            </button>
        </div>
            ...
            <div class="table-responsive rounded-3 shadow-sm">
                <table class="table table-bordered table-hover m-0" style="font-size: 0.88rem; width: 100%; min-width: 100%;">
                    <thead class="text-center">
                        <tr>
                            <th style="width: 50%; min-width: 200px;">Nombre</th>
                            <th style="width: 10%; min-width: 200px;">Unidad de Medición</th>
                            <th style="width: 20%; min-width: 200px;">Departamento</th>
    ...
    <section id="form" class="d-none">
        <h5>Formulario de Registro de Insumos</h5>
        <hr />
        <form id="formulario">
            ...
            <select class="form-control form-control-sm" id="departamento" required>
    ...
    <script src="../assets/js/ajaxInsumos.js"></script>
