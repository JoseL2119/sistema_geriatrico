...
<html lang="es">
  ...
  <body>
    ...
    <section id="lista">
        <div class="page-header">
            <h5>
                ...
                Listado de opciones de Status de los Residentes
            </h5>

            <button type="button" class="btn btn-primary btn-app shadow-sm" id="nuevo">
                <i class="fas fa-plus-circle me-2"></i>Nuevo Status
            </button>
        </div>
                ...
                <table class="table table-bordered table-hover m-0" style="font-size: 0.88rem; width: 100%; min-width: 100%;">
                    <thead class="text-center">
                        <tr>
                            ...
                            <th style="width: 70%; min-width: 200px;">Status</th>
    ...
    <section id="form" class="d-none">
        <h5>Formulario de Registro de Status</h5>
        <hr />
        <form id="formulario">
    ...
    <script src="../assets/js/ajaxStatus.js"></script>
