...
<html lang="es">
  <head>
    ...
    <title>Carga Tolvas Fino y Grueso</title>
  ...
  <body>
    ...
    <section id="lista">
        <h5>Historial de Carga de Tolvas con Mineral Fino y Grueso</h5>
        <hr />
        <div>
    ...
    <section id="form" class="d-none">
        <h5>Formulario para Nuevo Registro de Carga de Tolvas con Mineral Fino o Grueso/h5>
        <hr />
        <form id="formulario">
    ...
    <script src="../assets/js/ajaxTolvas.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.17.2/dist/sweetalert2.all.min.js"></script>

    <script type="text/javascript">
        function calcular(){
            try{
                var a = parseInt(document.getElementById("cantidadT").value) || 0;

                document.getElementById("total").value = a * 90;
            } catch(e){}
        }
