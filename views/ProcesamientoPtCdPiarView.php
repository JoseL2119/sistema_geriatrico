...
<html lang="es">
  <head>
    ...
    <title>Procesamiento CD Piar</title>
  ...
  <body>
    ...
    <section id="lista">
        <h5>Historial Procesamiento Ciudad Piar</h5>
        <hr />
        <div>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col">Mineral Procesado</th>
    ...
    <section id="form" class="d-none">
        <h5>Formulario para Nuevo Registro de Procesamiento en Ciudad Piar</h5>
        <hr />
        <form id="formulario">
            ...
            <div class="mb-3">
                <label for="mineral" class="form-label">Mineral Procesado</label>
    ...
    <script src="../assets/js/ajaxProcesamiento.js"></script>
