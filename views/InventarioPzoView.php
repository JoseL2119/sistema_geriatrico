...
<html lang="es">
  ...
  <body>
    ...
    <section id="lista">
        <h5>Inventario de Minerales de Puerto Ordaz</h5>
        <hr />
        <div>
    ...
    <section id="form" class="d-none">
        <h5>Formulario para Nuevo Registro Inventario de Minerales en Puerto Ordaz</h5>
        <hr />
        <form id="formulario">
    ...
    <script src="../assets/js/ajaxInventarioPzo.js"></script>
