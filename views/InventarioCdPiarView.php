...
<html lang="es">
  <head>
    ...
    <title>Inventario CD Piar</title>
  ...
  <body>
    ...
    <section id="lista">
        <h5>Inventario General de Minerales de Ciudad Piar</h5>
        <hr />
        <!-- <div>
        ...
        <table class="table">
            <thead>
                <tr>
                    <th scope="col">#</th>
                    <th scope="col">Material/Mineral</th>
                    <th scope="col">Mina/Planta</th>
    ...
    <script src="../assets/js/ajaxInventarioCdPiar.js"></script>
