...
<html lang="es">
  <head>
    ...
    <title>Inventario de Excavados CD Piar</title>
  ...
  <body>
    ...
    <section id="lista">
        <h5>Inventario de Mineral Excavado en Ciudad Piar</h5>
        <hr />
        <div>
    ...
    <section id="form" class="d-none">
        <h5>Formulario para Nuevo Registro de Inventario de Excavación en Ciudad Piar</h5>
        <hr />
        <form id="formulario">
    ...
    <script src="../assets/js/ajaxInventarioExc.js"></script>
