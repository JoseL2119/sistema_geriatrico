...
<html lang="es">
  <head>
    ...
    <title>Operadores Sala de Control</title>
  ...
  <body>
    ...
    <section id="lista">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <button type="button" class="btn btn-primary shadow-sm" id="nuevo">
                <i class="fas fa-plus-circle me-2"></i>Nuevo Operador
            </button>
        </div>
    ...
    <section id="form" class="d-none">
        <h5>Formulario de Registro de Operador</h5>
        <hr />
        <form id="formulario">
    ...
    <script src="../assets/js/ajaxOperadores.js"></script>
