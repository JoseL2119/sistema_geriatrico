...
<html lang="es">
  <head>
    ...
    <title>Operatividad Maquinaria</title>
  ...
  <body>
    ...
    <section id="lista">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h5 class="mb-0 fw-bold">
                ...
                Registros de Operatividad de Maquinaria
            </h5>
        </div>
            ...
            <div class="table-responsive rounded-3 shadow-sm">
                <table class="table table-bordered table-hover m-0" style="font-size: 0.88rem; width: 100%; min-width: 100%;">
                    <thead class="text-center" style="background-color: #c8e6c9;">
                        <tr>
                            <th style="width: 33%; min-width: 100px;">Fecha</th>
                            <th style="width: 33%; min-width: 100px;">Máquina</th>
                            <th style="width: 33%; min-width: 100px;">Total de horas trabajadas</th>
                        </tr>
                    </thead>
    ...
    <script src="../assets/js/ajaxOperatividad.js"></script>
    ...
    document.getElementById('pdf-link').addEventListener('click', function(e) {
        ...
        let url = '/views/reportes/ReporteOperatividad.php';
