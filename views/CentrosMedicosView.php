...
<html lang="es">
  <head>
    ...
    <title>Centros Médicos de Evaluación</title>
  ...
  <body>
    ...
    <section id="lista">
        <div class="page-header">
            <h5>
                ...
                Listado de Centros Médicos de Evaluación de Residentes
            </h5>

            <button type="button" class="btn btn-primary btn-app shadow-sm" id="nuevo">
                <i class="fas fa-plus-circle me-2"></i>Nuevo Centro
            </button>
        </div>
    ...
    <section id="form" class="d-none">
        <h5>Formulario de Registro de Centro Médico</h5>
        <hr />
        <form id="formulario">
    ...
    <script src="../assets/js/ajaxCentrosMedicos.js"></script>
