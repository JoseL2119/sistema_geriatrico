...
<html lang="es">
  ...
  <body>
            ...
            <div class="table-responsive rounded-3 shadow-sm">
                <table class="table table-bordered table-hover m-0" style="font-size: 0.88rem; width: 100%; min-width: 100%;">
                    <thead class="text-center" style="background-color: #c8e6c9;">
                        <tr>
                            <th style="width: 25%; min-width: 100px;">Fecha</th>
                            <th style="width: 25%; min-width: 100px;">Toneladas Humedas</th>
                            <th style="width: 25%; min-width: 100px;">%Humedad</th>
                            <th style="width: 25%; min-width: 100px;">Toneladas Secas</th>
                        </tr>
                    </thead>
    ...
    <script src="../assets/js/ajaxAlimentacion.js"></script>
